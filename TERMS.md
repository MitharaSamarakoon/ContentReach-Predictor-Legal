...
For the purposes of these Terms and Conditions:
  ...
  * Application means the software program provided by the Company downloaded
    by You on any electronic device, named ContentReach Predictor
  ...
  * Company (referred to as either "the Company", "We", "Us" or "Our" in these
    Terms and Conditions) refers to ContentReach Predictor.
...
us:
  ...
  * By email: samarakoonmithara32@gmail.com
